...
Let's download this from the UCSC for hg18, as that's the genome for some sample data we'll use in a minute.
(*Please ignore any warning about NCBI seqlevel was set to NA*)

```{r}
hg18 <- fetchExtendedChromInfoFromUCSC("hg18")
```
...
```{r}
autosomeSeq <-  Seqinfo(seqnames = hg18$NCBI_seqlevel[1:22],
                       seqlengths = hg18$UCSC_seqlength[1:22], 
